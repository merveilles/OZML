...
{	
  ...
  var glitchIntensity : SerializedProperty;
  var vignettingMat : SerializedProperty;
    ...
    glitchIntensity = serObj.FindProperty ("glitchIntensity");
    chromaticAberration = serObj.FindProperty ("chromaticAberration");
    vignettingMat = serObj.FindProperty ("glitchTexture");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (glitchIntensity, new GUIContent("Glitch Intensity"));    
    EditorGUILayout.PropertyField (vignettingMat, new GUIContent("Glitch Tex")); 
