...
class ContrastEnhance extends PostEffectsBase {
	...
	function OnRenderImage (source : RenderTexture, destination : RenderTexture) {	
		...
		contrastCompositeMaterial.SetFloat ("Contrast", Contrast);
		contrastCompositeMaterial.SetFloat ("Saturation", Saturation);
		contrastCompositeMaterial.SetFloat ("Brightness", Brightness);
